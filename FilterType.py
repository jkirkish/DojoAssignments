...
for element in test:
    if(type(element)== int and element >= 100):
        print (element,"That's a big number!")
    elif(type(element)== int and element < 100):
        print (element,"That's a small number!")
    if(type(element)== str and len(element) >= 50):
        print (element,"Long sentence",len(element))
    elif(type(element)== str and len(element) < 100):
        print (element,"Short sentence",len(element))
    if(type(element)== list and len(element) >= 10):
        print (element,"Long list",len(element))
    elif(type(element)== list and len(element) < 10):
        print (element,"Short list",len(element))
    else:
        print ("Need elements to evaluate", test)
